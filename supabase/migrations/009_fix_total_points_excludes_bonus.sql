-- Fix total_points: bonus_pts must NOT be included in total_points
-- total_points = picks points (group + knockout) + special_picks points ONLY
-- bonus_pts is shown as a display column and used as tiebreaker only
